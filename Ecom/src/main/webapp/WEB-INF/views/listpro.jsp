            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <td class="col-sm-8 col-md-6">
                        ...
                        <td class="col-sm-8 col-md-6">
                        <div class="media">
                            <a class="thumbnail pull-left" href="product?id=${p.id}"> <img class="media-object" src="${pageContext.request.contextPath}/resources/images1/${p.img}" style="width: 72px; height: 72px;"> </a>
