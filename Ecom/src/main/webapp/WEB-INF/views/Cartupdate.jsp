	...
	<table id="cart" class="table table-hover table-condensed">
					...
					<tbody>
						<tr>
							...
							<td data-th="Product">
								<div class="row">
									<div class="col-sm-2 hidden-xs"><img src="${pageContext.request.contextPath}/resources/images1/${ca.pid.img}" alt="..." class="img-responsive"/></div>
									<div class="col-sm-10">
										<h4 class="nomargin">${ca.pid.name}</h4>
									</div>
								</div>
							</td>
							<td data-th="Price">${ca.pid.price}</td>
